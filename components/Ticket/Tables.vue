...
const stats = [
  { name: 'TOTAL Ticket', value: store.total, unit: 'posts' },
  { name: '진행될 Ticket ', value: '30', unit: 'posts' },
  { name: '진행중 Ticket', value: '20', unit: 'posts' },
  { name: '종료 Ticket', value: '9', unit: 'posts' },
]
...
const modalEdit = (id) => {
  router.push(`/admin/ticket/edit?id=${id}`);
}
