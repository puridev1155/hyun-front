...
import { mypaymentsInfo, dataCrud } from '../../stores/index'
...
const categoryList  = await crud.crudApi(null, null, `/admin/mypayments`, 'get');
...
const modalEdit = (id) => {
  router.push(`/admin/mypayment/edit?id=${id}`);
}
