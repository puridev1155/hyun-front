...
import { dataCrud, myproductsInfo } from '../../stores/index'
...
const modalEdit = (id) => {
  router.push(`/admin/myproduct/edit?id=${id}`);
}
...
function deleteData(id) {
  ...
  Swal.fire({
    ...
    if (result.isConfirmed) {
     ...
     await $fetcher(useRuntimeConfig().public.backendUrl + `/api/admin/myproducts/${id}`, {
        method: "delete",
        credentials: 'include',
      });
