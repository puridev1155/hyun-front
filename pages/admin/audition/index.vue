                ...
                <!-- Search Start -->
                  <AuditionSearch />
                   ...
                   <div class="mt-3 mb-5">
                          ...
                          <nuxt-link to="/admin/audition/create"
...
{ name: '전체',  url: '/admin/audition',},
{ name: '홍보',  url: '/admin/audition?page=1&board=event',},
{ name: '한국',  url: '/admin/audition?page=1&langId=1', },
{ name: '일본',  url: '/admin/audition?page=1&langId=2', },
{ name: '인도네시아',  url: '/admin/audition?page=1&langId=3',  },
{ name: '미국',  url: '/admin/audition?page=1&langId=4',  },
]

// Top Nav
const navs = [
  { name: 'Audition', href: '#', current: false },
  { name: 'Audition Table', href: '#', current: true },
]
