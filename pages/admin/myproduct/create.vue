<template>
                ...
                <div class="px-4 pt-10">
                  ...
                  <div>
                    ...
                    <div class="mt-4 grid grid-cols-1 gap-y-6 sm:grid-cols-3 sm:gap-x-4">
                      ...
                      <div>
                        <label for="country" class="block text-sm font-medium text-gray-700 mb-1">Select Language(언어 선택)</label>
                        <div class="mt-1">
                    ...
                    <div>
                        ...
                        <div v-for="(row, index) in inputBoxes" :key="index">
                    ...
                    <div class=" px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6 justify-center">
                      <div class=" px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6 justify-center">
                        ...
                        <button type="button"
                          ...
                          @click="createPost()" ref="cancelButtonRef">수정</button>
                      </div>
                    </div>
                  </div>
                <!-- Form End-->
  ...
  form.value.category_id = null; //선택 option 1
...
const priceAdd = () => {
  ...
  const createPost = () => {
    ...
    if (result.isConfirmed) {
      Swal.fire(
        ...
        console.log(form.value.prices, 'prices')
        ...
        store.crudApi(formData, form.value, '/admin/myproducts', 'post'); //Parameter (bodyData, paramsData, postUrl, methodType)
        router.push({ path: `/admin/myproduct` })
    }
  })
  ...
  if (form.value.lang_id === null) {
    alert("언어를 선택하세요");
    isValid = false;
  } else if (form.value.product_name === undefined || form.value.product_name === '') {
    alert("제목을 입력하세요");
    isValid = false;
    ...
    alert("가격을 추가 입력하세요");
    isValid = false;
  } else if (form.value.description === null) {
    alert("내용을 입력하세요.");
    isValid = false;
  } else if (form.value.info === null) {
    alert("내용을 입력하세요.");
    isValid = false;
  } else if (form.value.shipping === null) {
    alert("배송내용을 입력하세요.");
    isValid = false;
  }
