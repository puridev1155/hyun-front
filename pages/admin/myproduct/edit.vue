...
form.value = await store.crudApi(null, null, `/admin/myproducts/${route.query.id}`, 'get'); //Parameter (body, params.  postUrl, methodType)
...
const updatePost = () => {
  ...
  Swal.fire({
    ...
    if (result.isConfirmed) {
      ...
      store.crudApi(formData, form.value, `/admin/myproducts/${route.query.id}`, 'post'); //Parameter (body, params.  postUrl, methodType)  
