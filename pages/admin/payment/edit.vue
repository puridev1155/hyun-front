              ...
              <div class="px-4 pt-10">
                <!-- Form Start-->
                  <div>
                    ...
                    <div v-if="form.price_agree || form.age_agree || form.ticket_agree" class="mt-4 grid grid-cols-1 gap-y-6 sm:grid-cols-3 sm:gap-x-4">
                      <div v-if="form.price_agree">
                        ...
                        <div  v-if="form.ticket_agree">
                          ...
                          <div class="mt-1">
                            <input type="number" name="age" v-model="form.ticket_limit" placeholder="100"
                              class="block w-full rounded-md border-gray-300 bg-white py-3 px-4 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                          </div>
                        </div>
                    </div>
...
const updatePost = () => {
  ...
  Swal.fire({
    ...
    if (result.isConfirmed) {
      ...
      form.value.ticket_limit = form.value.ticket_agree ? form.value.ticket_limit : 0;
